...
const SHELL=[BASE+"spark/",BASE+"studio/",BASE+"manifest.webmanifest",BASE+"infinity-icon-192.png",BASE+"infinity-icon-512.png",BASE+"infinity-preview-v2.jpg"];
