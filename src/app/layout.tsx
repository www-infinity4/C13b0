...
export const metadata: Metadata = {
  metadataBase: new URL(siteUrl), title: "Infinity Phi Search — C13b0", applicationName: "Infinity Phi Search",
  description: "Infinity Phi Search — indexing, extraction, higher-context decisions and transfer into your world.", alternates: { canonical: siteUrl },
  openGraph: { type: "website", url: siteUrl, siteName: "Infinity Phi Search", title: "Infinity Phi Search — C13b0", description: "All knowledge. All perspectives. One search. A deeper internet, a clearer tomorrow.", images: [{ url: phiPreview, width: 1536, height: 1024, alt: "Infinity Phi Search C13b0 — indexing, extraction, decision and transfer" }] },
  twitter: { card: "summary_large_image", title: "Infinity Phi Search — C13b0", description: "All knowledge. All perspectives. One search. A deeper internet, a clearer tomorrow.", images: [phiPreview] },
};
export const viewport: Viewport = { themeColor: "#071f38", viewportFit: "cover" };

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const base = appBase();
  return <html lang="en" className="scroll-smooth"><body className="min-h-screen antialiased" style={{ background: "var(--background)" }}>
    ...
    <AppRuntime/><OpenSourceUsageRuntime/><SiteChrome>{children}</SiteChrome><OpenSourceBuildCredits className="open-source-global-footer" showChatGPT={false}/>
    ...
    <Script src={`${base}/infinity-phi-image-mode-v1.js?v=20260916-image-mode1`} strategy="afterInteractive" />
    <Script src={`${base}/infinity-phi-image-mode-v2.js?v=20260916-image-mode2`} strategy="afterInteractive" />
    ...
    <Script src={`${base}/infinity-phi-results-controls-v1.js?v=20260917-results-controls1`} strategy="afterInteractive" />
  </body></html>;
}
